...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <h5>Data Desa Kecamatan <?= $kecamatan->kecamatan_nama ?></h5>
        </div>
        <div class="card-body">
            <div class="container">
                <div class="container mt-3 mb-5">
                    <a href="<?= base_url('admin/kecamatan/' . $kecamatan->kecamatan_id . "/desa/tambah") ?>" class="btn btn-primary">Tambah Desa</a>
                </div>
...
<script>
    function getTable() {
        ...
        $.ajax({
            method: "POST",
            url: "<?= base_url('admin/kecamatan/' . $kecamatan->kecamatan_id . '/desa') ?>",
            data: formData,
            processData: false,
            contentType: false,
            cache: false,
