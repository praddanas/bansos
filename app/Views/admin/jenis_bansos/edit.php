                ...
                <div class="container mt-3 mb-5">
                    ...
                    <form>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?= $jenis_bansos->jenis_nama ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('form').submit(function(e) {
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url('admin/jenis_bansos/' . $jenis_bansos->id . "/edit") ?>",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
