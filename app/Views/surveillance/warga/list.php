    ...
    <tbody class="table-group-divider">
        ...
        ?>
            <tr class="text-center">
                ...
                <td>
                    <a type="button" href="<?= base_url('surveillance/warga/' . $warga['warga_id'] . "/detail") ?>" class="btn btn-warning">Lihat</a>
                    <a type="button" href="<?= base_url('surveillance/warga/' . $warga['warga_id'] . "/edit") ?>" class="btn btn-primary">Edit</a>
        ...
        $('#datatabledata').on('click', '.btnHapusData', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "<?= base_url('surveillance/warga') ?>/" + id + '/delete',
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
